  ...
  return (
    <div className='login_con shadow-lg  bg-white'>
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control  value={loginName} onChange={(e)=>setLoginName(e.target.value)} placeholder="Enter user name phone or email" />
      ...
      <Button variant="primary" type="submit" size="md"  disabled={!(loginName && password)}>
         {loading && <Spinner
          as="span"
          animation="grow"
          size="sm"
    ...
    fields="name,email,picture"
     ...
     {error && <Form.Group className="form-con errormsg" controlId="formBasicCheckbox">
        <p>{message}</p>
