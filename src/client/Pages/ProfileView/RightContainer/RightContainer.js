...
function RightContainer({userData}) {
  return (
    <div className='right-cover'  >
      <div className='cover-pic-dexktop'  style={{ background: `url(${process.env.REACT_BASE_API_IMAGES + userData.coverpic?.destination +'/'+ userData.coverpic?.filename}), #3e505e` }}>
